   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  17:	52                   	push   %edx
  18:	52                   	push   %edx
  19:	68 44 08 00 00       	push   $0x844
  1e:	6a 02                	push   $0x2
  20:	e8 2b 04 00 00       	call   450 <printf>
    exit();
  25:	e8 c5 02 00 00       	call   2ef <exit>
  }
  ...
  32:	e8 18 03 00 00       	call   34f <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 ac 02 00 00       	call   2ef <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	push   0x8(%ebx)
  46:	ff 73 04             	push   0x4(%ebx)
  49:	68 57 08 00 00       	push   $0x857
  4e:	6a 02                	push   $0x2
 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 cc 08 00 00 	movzbl 0x8cc(%edx),%edx
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4c4:	ff 24 85 74 08 00 00 	jmp    *0x874(,%eax,4)
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 6b 08 00 00       	mov    $0x86b,%ebx
...
free(void *ap)
{
 ...
 5e1:	a1 44 0c 00 00       	mov    0xc44,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 44 0c 00 00       	mov    %eax,0xc44
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 44 0c 00 00       	mov    %eax,0xc44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 44 0c 00 00    	mov    0xc44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bb:	3b 05 44 0c 00 00    	cmp    0xc44,%eax
 ...
 6de:	e8 fd fe ff ff       	call   5e0 <free>
  return freep;
 6e3:	8b 15 44 0c 00 00    	mov    0xc44,%edx
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 70f:	89 15 44 0c 00 00    	mov    %edx,0xc44
}
 ...
 71f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 44 0c 00 00 48 	movl   $0xc48,0xc44
 727:	0c 00 00 
    base.s.size = 0;
 72a:	b8 48 0c 00 00       	mov    $0xc48,%eax
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 48 0c 00 00 48 	movl   $0xc48,0xc48
 736:	0c 00 00 
    base.s.size = 0;
 739:	c7 05 4c 0c 00 00 00 	movl   $0x0,0xc4c
 740:	00 00 00 
    if(p->s.size >= nunits){
