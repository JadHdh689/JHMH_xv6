...
_proccount:     file format elf32-i386
...
main(void)
{
  ...
  int n = getprocs();
  11:	e8 49 03 00 00       	call   35f <getprocs>
  printf(1, "procs=%d\n", n);
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 14 08 00 00       	push   $0x814
  1f:	6a 01                	push   $0x1
  21:	e8 fa 03 00 00       	call   420 <printf>
  exit();
  26:	e8 94 02 00 00       	call   2bf <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3bb:	0f b6 92 80 08 00 00 	movzbl 0x880(%edx),%edx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 494:	ff 24 85 28 08 00 00 	jmp    *0x828(,%eax,4)
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 1e 08 00 00       	mov    $0x81e,%ebx
...
free(void *ap)
{
 ...
 5b1:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 f4 0b 00 00    	cmp    0xbf4,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 6f7:	0b 00 00 
    base.s.size = 0;
 6fa:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 706:	0b 00 00 
    base.s.size = 0;
 709:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 710:	00 00 00 
    if(p->s.size >= nunits){
